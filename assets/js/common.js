...
const PAGE_TITLES = {
  ...
  ingest: ['数据采集与调用日志', '问卷 2.1 / 3.1 · 配置全部写死，仅提供对接调用日志'],
  evidence: ['存证与岗位交接', '问卷 4.1 · 附件统一写入客户指定服务器（写死）'],
  alerts: ['预警通知配置', '问卷 5.1 / 5.2 · 仅邮件通道 + 语音告警'],
  mail: ['邮件内容展示', '问卷 5.1 · 邮件正文写死，本页仅供演示投递效果']
};
